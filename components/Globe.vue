...
window.delayedJavascriptArray.push(function () {
  window.otApi.GlobeGL = {
    // Settings
    $trigger: document.querySelector(".js-globe-gl"),
    jsFiles: ["https://unpkg.com/globe.gl", "https://d3js.org/d3.v7.min.js"],
    ...
    init: function () {
      if (this.$trigger.length) {
        ...
        if (!isReduced || isReduced.matches) {
          ...
          window.otApi.addJSFiles(this.jsFiles, this.applyGlobeGL);
        }
      }
    },
